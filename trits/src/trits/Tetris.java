...
public class Tetris extends Application{
	...
	private static int linesNo = 0;
        ...
        // تنفيذ اللعبة بعد الحصول على اسم اللاعب
        }
	...
	public void start(Stage stage) throws Exception {
                    ...
                    // إنشاء حوار لإدخال اسم اللاعب
        Dialog<String> dialog = new Dialog<>();
        dialog.setTitle("Enter Your Name");
        dialog.setHeaderText(null);
        dialog.setResizable(false);
                    // إضافة مربع نص لإدخال اسم اللاعب
        ...
        button.setOnAction(event -> {
            ...
            // بدء اللعبة بعد الحصول على اسم اللاعب
		...
		Text pName = new Text("Player Name : " + playerName);
                pName.setFill(Color.WHITE);
		pName.setStyle("-fx-font: 20 arial;");
		pName.setY(50);
		pName.setX(XMAX + 35);
		...
		group.getChildren().addAll(scoretext, level , pName);
